...
function getDatabaseUri() {
    ...
    // if DATABASE URL enviornment varaible, use that
    // otherwise create the db connection string ourselves

    return process.env.DATABASE_URL || 'postresql://' + dbUser + ':' + dbPass + '@' + dbHost + ':' + dbPort + '/' + dbName
}

//console.log("process.env".yellow, Object.keys(process.env))
console.log("Vaccine Hub Api Config".red)
